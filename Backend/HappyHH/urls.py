...
from chatting.views import InitiateChatView, SellerChatRequestsView, DeleteChatRequestView
...
urlpatterns = [
    ...
    path('chat/requests/', SellerChatRequestsView.as_view()),
    path('chat/requests/<str:room_id>/', DeleteChatRequestView.as_view()),
